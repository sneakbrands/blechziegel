"""Build Blechziegel-CI PDF from AUDIT_ENTERPRISE.md via Chrome Headless."""
import markdown
import subprocess
import datetime
...
MD = ROOT / "AUDIT_ENTERPRISE.md"
HTML = ROOT / "AUDIT_ENTERPRISE.html"
PDF = ROOT / "AUDIT_ENTERPRISE.pdf"
...
<head>
<meta charset="utf-8">
<title>Enterprise-Audit · blechziegel.de</title>
...
<style>
  ...
  @page {{
    ...
    @bottom-left {{ content: "Enterprise-Audit · blechziegel.de"; font-family: 'Open Sans', sans-serif; font-size: 9pt; color: #5a5955; }}
  ...
  * {{ box-sizing: border-box; }}
  ...
  tbody tr:hover td {{ background: var(--bz-orange-light); }}
  ...
  /* Anchor links (md footnotes / toc) subtle */
  a {{ color: var(--bz-orange-dark); text-decoration: none; }}
  a:hover {{ text-decoration: underline; }}

  /* Section spacing on page-break */
...
<section class="cover">
  ...
  <div class="cover-body">
    <div class="cover-kicker">Enterprise-Audit · Shopify Theme</div>
    <h1 class="cover-title">Technisches, UX &amp; SEO Audit<br>des produktiven Themes</h1>
    <p class="cover-sub">Priorisierte Analyse kritischer Risiken, Conversion-Hebel und struktureller Architekturprobleme. Jedes Finding belegt mit Datei &amp; Zeile.</p>
  </div>
  ...
  <div class="cover-meta">
    ...
    <div class="cover-meta-item">
      <div class="cover-meta-label">Theme-Basis</div>
      <div class="cover-meta-value">Horizon 3.5.0 · Custom</div>
    </div>
    <div class="cover-meta-item">
